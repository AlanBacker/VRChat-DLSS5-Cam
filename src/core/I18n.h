...
#define VDC_STRING_LIST(X) \
    ...
    X(TipSkinStructure,   "Detail on skin-like surfaces. \"Runtime default\" leaves it to the model.", "皮肤类表面的细节。“使用默认值”由模型自行决定。", "肌のような表面のディテール。「既定値を使用」でモデルに任せます。", "피부 같은 표면의 디테일. \"기본값 사용\"이면 모델에 맡깁니다.") \
