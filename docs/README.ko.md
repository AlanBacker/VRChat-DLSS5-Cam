...
- **낮은 프레임률** – DLAA를 끄거나, 깊이 갱신 간격을 늘리거나 깊이 네트워크 해상도를 낮추거나, 처리 속도 상한을 설정합니다. 옵티컬 플로우 그리드는 4 px로 두는 편이 좋습니다(2 px와 1 px는 4K에서 훨씬 무겁습니다). 로그에는 15초마다 각 단계의 비용이 담긴 `Perf:` 줄이 기록됩니다.
