...
| DLSS 5 | 強度 | ニューラルパス全体の強さ（0–1、ランタイム自身の範囲）。 |
| DLSS 5 | グローバルトーン / ローカルトーン | グローバル・ローカルのトーンマッピング強度（0–1。ランタイムは強度をこの範囲に制限します）。 |
| DLSS 5 | ローカル構造 / 肌の構造 | ディテール強調（0–1）。肌の構造はランタイム既定のままにできます。 |
